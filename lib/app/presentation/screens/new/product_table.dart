          ...
          children: [
            ...
            SingleChildScrollView(
              ...
              child: DataTable(
                  ...
                  rows: List.generate(widget.outlet.products!.length, (index) {
                    return DataRow(
                      cells: <DataCell>[
                        ...
                        DataCell(Text(widget.outlet.products![index].category)),
                        DataCell(Text(widget.outlet.products![index].channel)),
                        DataCell(Text(widget.outlet.products![index].isAvailable
                            .toString())),
